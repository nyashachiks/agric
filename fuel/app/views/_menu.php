  ...
  <div class="container-fluid">
   ...
   <li class="dropdown">
   	<a href="" class="dropdown-toggle" data-toggle="dropdown">
   		...
   		<ul class="dropdown-menu">
	   		<li>
	   			<a href="<?php echo Uri::create('permits/create'); ?>">Apply for a permit</a>
	   		</li>
	   		<li>
	   			<a href="<?php echo Uri::create('permits'); ?>">Submitted permits</a>
	   		</li>
   		</ul>
   </li>
   ...
   <li class="dropdown">
   	...
   	<ul class="dropdown-menu">
   		<li>
   			<a href="<?php echo Uri::create('reports/product/bydistrict'); ?>">Product by district</a>
   		</li>
   		<li>
   			<a href="<?php echo Uri::create('reports/farm/bydistrict'); ?>">Farm by district</a>
   		</li>
   		<li>
   			<a href="<?php echo Uri::create(); ?>">Summary of Offers by Province</a>
   		</li>
   		<li>
   			<a href="<?php echo Uri::create(); ?>">Summary of Offers by District</a>
   		</li>
   	</ul>
   </li>

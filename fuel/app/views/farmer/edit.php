	...
	<div class="row">
		<div class="col-md-10 col-md-offset-2">
			<div class="hero-content text-center">
				<h2 class="landing-h1" style="" align="center">Edit Farmer</h2>
			</div>
		</div>
	</div>
			...
			<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<div class="col-md-7 col-sm-7 col-xs-12">
									<?php 
										echo Form::select('gender', Input::post('gender', isset($user_profile) ? $user_profile->gender : ''),
			...
			<div class="row">
				...
				<div class="col-md-6">
					<div class="form-group">
						...
						<div class="col-md-7 col-sm-7 col-xs-12">
							<?php echo Form::input('national_id', Input::post('national_id', isset($user_profile) ? $user_profile->national_id : ''), array('class' => 
			...
			<div class="row">
				...
				<div class="col-md-6">
					<div class="form-group">
						...
						<div class="col-md-7 col-sm-7 col-xs-12">
							<?php echo Form::input('date_of_birth', Input::post('date_of_birth', isset($user_profile) ? $user_profile->date_of_birth : ''), array('class' => 'col-md-4 form-control datepicker',  'id'=>'dob')); ?>
						</div>
					</div>
			...
			<div class="row">
				<div class="col-md-6">
					...
					<div class="form-group">
						...
						<div class="col-md-7 col-sm-7 col-xs-12">
								<?php echo Form::input('payment_term', Input::post('payment_term', isset($user_profile) ? $user_profile->payment_term : ''), array('id'=>'payment_term','class' => 

							'form-control input-sm2','disabled'=>'disabled', 'style' => 'background: #fff')); ?>
							<?php echo Form::input('payment', Input::post('payment', isset($user_profile) ? $user_profile->payment_term  : ''),
			...
			<div class="row">
				<div class="col-md-6">
					<div class="form-group">
						...
						<div class="col-md-7 col-sm-7 col-xs-12">
							<?php echo Form::input('branch_code', Input::post('branch_code', isset($bank) ? $bank->branch_name  : ''),
										 			array('id' => 'branch_code','class'=> 'form-control input-sm2','disabled'=>'disabled', 'style' => 'background: #fff')); ?>

							<?php echo Form::input('branch', Input::post('branch', isset($bank) ? $bank->branch_name  : ''),
				...
				<div class="col-md-6">
					<div class="form-group">
						...
						<div class="col-md-7 col-sm-7 col-xs-12">
								<?php echo Form::input('bank', Input::post('bank', isset($bank) ? $bank->bank_name : ''), array('id' => 'bank', 'class' => 
							'form-control input-sm2','disabled'=>'disabled', 'style' => 'background: #fff')); ?>


							<?php echo Form::input('bank_name', Input::post('bank_name', isset($bank) ? $bank->bank_name : ''), array('id' => 'bank_name', 'type'=>'hidden')); ?>

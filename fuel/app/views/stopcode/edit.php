<h2>Editing <span class='muted'>Stopcode</span></h2>
<br>
	...
	<fieldset>
		...
		<div class="form-group">
			<?php echo Form::label('Description', 'description', array('class'=>'control-label')); ?>
				...
				<?php echo Form::input('description_i', Input::post('description_i', isset($stopcode) ? $stopcode->description : ''), array('class' => 'col-md-4 form-control', 'placeholder'=>'Description','disabled'=>'disabled','id'=>'description_i')); ?>

				<?php echo Form::input('description', Input::post('description', isset($stopcode) ? $stopcode->description : ''), array('type'=>'hidden','id'=>'description')); ?>
...
<?php echo Form::close(); ?>
<p>
	<?php echo Html::anchor('stopcode/view/'.$stopcode->id, 'View'); ?> |
	<?php echo Html::anchor('stopcode', 'Back'); ?></p>

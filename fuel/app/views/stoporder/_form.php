<style>
#company_code_i , #pickerCo, #pickerCode ,#farmer_number ,#stop_code ,#material ,#depot{
...
<script>
	$(function(){
		...
		d= new Date()
		$(".datepicker").datepicker('setDate', new Date(d.getFullYear(), 3, 01));
	});
</script>
...
<?php echo Form::open(array("class"=>"form-horizontal")); ?>
	...
	<fieldset>
		...
		<!--div class="form-group">
			<?php echo Form::label('Stop order number', 'stop_order_number', array('class'=>'control-label')); ?>
				...
				<?php echo Form::input('stop_order_number', Input::post('stop_order_number', isset($stoporder) ? $stoporder->stop_order_number : ''), array('class' => 'col-md-4 form-control', 'placeholder'=>'Stop order number')); ?>

		</div-->
		<?php echo Form::label('Code', 'code', array('class'=>'control-label')); ?>
		<div class="form-group">
				
				<?php echo Form::input('stop_code', Input::post('stop_code', isset($stoporder) ? $stoporder->code : ''), array('class' => 'col-md-4 form-control', 'id'=>'stop_code','disabled'=>'disabled')); ?>
				<?php echo Form::input('code', Input::post('code', isset($stoporder) ? $stoporder->code : ''), array('id'=>'code','type'=>'hidden')); ?>

				<span class="input-group-addon libspicker " onclick="viewCode()" 'id'="pickerCode">Pick Code</span>
		...
		<div class="form-group">
				...
				<?php echo Form::input('farmer_number_code', Input::post('farmer_number_code', isset($stoporder) ? $stoporder->farmer_number : ''), array('class' => 'col-md-4 form-control', 'placeholder'=>'Farmer number' ,'id'=>'farmer_number')); ?>

				<?php echo Form::input('farmer_number', Input::post('farmer_number', isset($stoporder) ? $stoporder->farmer_number : ''), array('id'=>'farmer_number_code','type'=>'hidden')); ?>
		...
		<div class="form-group">
			<?php echo Form::label('Farmer name', 'farmer_name', array('class'=>'control-label')); ?>
				...
				<?php echo Form::input('farmer_name', Input::post('farmer_name', isset($stoporder) ? $stoporder->farmer_name : ''), array('id'=>'farmer_name', 'type'=>'hidden')); ?>
	...
	<?php echo render('stoporder/_pickCode'); ?>

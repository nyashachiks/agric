...
<div class="row-fluid">
	<div class="panel panel-default">
		<div class="panel-heading">
			<h1>Agronomist Report</h1>
		</div>
		<div class="panel-body">
			<div class="row">
				<form method="post">
					<div class="col-md-2">
						<p class="text-left">Select an Agronomist</p>
					</div>
					<div class="col-md-6">
					<?php
						echo Form::select('id', 'none',Model_User::get_userid('-- Select an Agronomist --'),array('class' => 'form-control input-sm', 'onchange'=>'agentid()','id'=>'selectedagent')
...
<div style="float: right">
	...
	{
				$dist = $sel_product_id;
				echo Form::button('print', '<i class="glyphicon glyphicon-print"></i> Print Agronomist', 
...
<div class="col-md-8">
	...
	<div class="col-md-4">
		...
		<tbody>
			<tr>
				<td class="report-stat-label">Selected Agronomist:</td>

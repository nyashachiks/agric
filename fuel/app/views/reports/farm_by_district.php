		...
		<div class="panel-body">
			<div class="row">
				<form method="post">
					...
					<div class="col-md-6">
					<?php
						echo Form::select('district', 'none',Model_Address::get_districts('-- Select a district --'),array('class' => 'form-control input-sm', 'onchange'=>'agentid()','district'=>'selectedagent')
...
<div style="float: right">
	...
	if(isset($report_generated) and $report_generated == true)
	{
				...
				echo Form::hidden('contract', $dist); 
					 echo Html::anchor('reports/farm/bydistrictfarm/excel/'.$dist,"Excel",array('class'=>'btn btn-success btn-md'));
				echo Form::hidden('agent', $dist, array('district'=>'agent_id')); 
				}
		?>	
...
<div class="row-fluid">
	<table class="table table-striped table-bordered">
		<thead>
			<th class="col-xs-1">Farm ID</th>
			<th class="col-xs-4">Farm name</th>
...
<div class="row-fluid">
	<div class="col-md-12 col-xs-12">
		<div class="alert alert-danger">
			<p>There are no farms to display. Try another search.</p>
		</div>
	</div>
</div>
...
function agentid()
	...
	{
		   var html="<html>";
		   html+= document.getElementById('printDistrict').innerHTML;
...
$('#cmd').click(function () {
    doc.fromHTML($('#printDistrict').html(), 15, 15, {
        'width': 300, 
            'elementHandlers': specialElementHandlers
    });
    var filename=document.getElementById('district').value;

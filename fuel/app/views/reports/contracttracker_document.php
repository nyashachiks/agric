		...
		<div class="panel-body">
			<div class="row">
				<form method="post">
					...
					<div class="col-md-6">
					<?php
						echo Form::select('id', 'none',Model_User::get_userFarmerid('-- Select a Farmer --'),array('class' => 'form-control input-sm', 'onchange'=>'agentid()','id'=>'selectedagent')
...
<div style="float: right">
	...
	if(isset($report_generated) and $report_generated == true)
	{
				...
				echo Form::hidden('contract', $dist); 
					 echo Html::anchor('reports/contracttracker/bycontracttracker/excel/'.$dist,"Excel",array('class'=>'btn btn-success btn-md'));
...
$('#cmd').click(function () {
    doc.fromHTML($('#printContractTracker').html(), 15, 15, {
        'width': 300, 

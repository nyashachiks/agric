	...
	<table class="table table-striped table-bordered">
		<tbody>
			<tr>
				...
				<?php if(isset($show_update_disburse_text_field) and $show_update_disburse_text_field): ?>
					<button class="btn btn-primary btn-md">Disburse</button>
				<?php endif; ?>
<?php echo render('utilities/closeform.php');?>
					...
					<?php if(empty($contract->so)): ?>
						...
						<button type="button" id="do_it" class="btn btn-success btn-md">
						Apply for Stop Order</button>
						<?php else: ?>
				...
				<?php endif; ?>
					...
					<a href="<?php echo Uri::create('contract/contractor_indexmine'); ?>" 

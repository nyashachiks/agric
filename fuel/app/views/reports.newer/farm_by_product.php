		...
		<div class="panel-body">
			<div class="row">
				<form method="post">
					...
					<div class="col-md-6">
					<?php
						echo Form::select('id', 'none',Model_Product::get_select_options('-- Select a product --'),array('class' => 'form-control input-sm')
...
while($row = mysqli_fetch_array($result)){ 
    ...
    $objPHPExcel->getActiveSheet()->SetCellValue('A'.$rowCount, $row['pd']); 
...
$objWriter->save('../../../farm_by_product.xlsx'); 

<nav class="navbar navbar-default">
  <div class="container-fluid">
   ...
   <ul class="nav navbar-nav ">
	   ...
	   <li class="dropdown">
			...
			<ul class="dropdown-menu">
				<li>
					<a href="<?php echo Uri::base();?>labor/indexview">
						View Labor Available
					</a>
				</li>
				<li>
					<a href="<?php echo Uri::base();?>logistic/indexview">
						View Equipment for Hire
					</a>
				</li>
   ...
   endforeach;
   ?>
   <li><a href="<?php echo Uri::base();?>user/view">Profile</a></li>

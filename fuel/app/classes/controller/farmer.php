<?php
class Controller_Farmer extends Controller_Template

{
    ...
    public function action_csvtodb()
    {
        
        $this->template->title = "Users";
        $this->template->content = View::forge('farmer/csvtodb', null);
        ...
        for($var = 0 ;$var <= 7 ; $var++)
            {
                ...
                $file = DOCROOT.'/assets/docs/csv/farmer0'.$var;
                //Debug::dump($file);die;

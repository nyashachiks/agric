...
var zim_d_a=new Array();
zim_d_a[0]="";
zim_d_a[1]="Bulawayo";
zim_d_a[2]="Harare";
zim_d_a[3]="Buhera|Chimanimani|Chipinge|Makoni|Mutare|Mutasa|Nyanga";
zim_d_a[4]="Bindura|Guruve|Mazowe|Mbire|Mukumbura|Muzarabani|Rushinga|Shambva";
zim_d_a[5]="Chikomba|Groromonzi, Hwedza|Marondera|Mudzi|Murehwa|Mutoko|Seke|Uzumba-Maramaba-Pfungwe";
zim_d_a[6]="Chegutu|Hurungwe|Kadoma|Kariba|Makonde|Zvimba";
zim_d_a[7]="Bikita|Chiredzi|Chivi|Gutu|Masvingo|Mwenezi|Zaka";
zim_d_a[8]="Binga|Bubi|Hwange|Lupane|Nkayi|Tsholotsho|Umguza";
zim_d_a[9]="Beitbridge|Bulilimamangwe|Gwanda|Insiza|Matobo|Umzingwane";
zim_d_a[10]="Chirumanzu|Gokwe North|Gokwe South|Gweru|Kwekwe|Mberengwa|Shurugwi|Zvishavane";

var moz_d_a=new Array();
moz_d_a[0]="";
moz_d_a[1]="Ancuabe|Balama|Chiúre|Ibo|Macomia|Mecúfi|Meluco|Mocímboa da Praia|Montepuez|Mueda|Muidumbe|Namuno|Nangade|Palma|Pemba-Metuge|Quissanga";
moz_d_a[2]="Bilene Macia|Chibuto|Chicualacuala|Chigubo|Chókwè|Guijá|Mabalane|Manjacaze|Massangena|Massingir|Xai-Xai";
moz_d_a[3]="Funhalouro|Govuro|Homoine|Inharrime|Inhassoro|Jangamo|Mabote|Massinga|Morrumbene|Panda|Vilanculos|Zavala";
moz_d_a[4]="Báruè|Gondola|Guro|Machaze|Macossa|Manica|Mossurize|Sussundenga|Tambara";
moz_d_a[5]="Maputo";
moz_d_a[6]="Boane|Magude|Manhiça|Marracuene|Matutuíne|Moamba|Namaacha";
moz_d_a[7]="Angoche|Eráti|Lalaua|Malema|Meconta|Mecubúri|Memba|Mogincual|Mogovolas|Moma|Monapo|Mossuril|Muecate|Murrupula|Nacala-a-Velha|Nacarôa|Nampula|Ribáuè";
moz_d_a[8]="Cuamba|Lago|Lichinga|Majune|Mandimba|Marrupa|Maúa|Mavagoago|Mecanhelas|Mecula|Metarica|Muembe|N'gauma|Nipepe|Sanga";
moz_d_a[9]="Buzi|Caia|Chemba|Cheringoma|Chibabava|Dondo|Gorongosa|Marromeu|Machanga|Maringué|Muanza|Nhamatanda";
moz_d_a[10]="Angónia|Cahora-Bassa|Changara|Chifunde|Chiuta|Macanga|Magoé|Marávia|Moatize|Mutarara|Tsangano|Zumbo";
function populateStates( countryElementId, stateElementId, districtElementId ){
	...
	for (var i=0; i<state_arr.length; i++) {
		...
		if(districtElementId){
			//district=document.getElementById( 'district_2' ).style.display="none";
			state_district=document.getElementById( districtElementId ).style.display="block";
			stateElement.onchange = function(){
			populateDistricts( countryElementId, stateElementId, districtElementId  );
			};
		}

}
function populateDistricts( countryElementId, stateElementId, districtElementId ){
	var country=document.getElementById( countryElementId ).value;
	...
	if(country=='Zimbabwe')
	{
		var district_arr = zim_d_a[selectedStateIndex].split("|");
	}
	else if(country=='Mozambique')
	{
		var district_arr = moz_d_a[selectedStateIndex].split("|");
	}
...
function populateCountries(countryElementId, stateElementId, districtElementId){
	// given the id of the <select> tag as function argument, it inserts <option> tags
	var countryElement = document.getElementById(countryElementId);
	isNotPreloaded=false;
	...
	if(isNotPreloaded)
		{
			$('#'+countryElementId+' option[value="Zimbabwe"]').prop("selected", true);
		}
	//alert(countryElement.length);
	if( stateElementId ){
		countryElement.onchange = function(){
			populateStates( countryElementId, stateElementId, districtElementId  );
			populateDistricts( countryElementId, stateElementId, districtElementId  );
		};
	}
}